...
# @description This script will install Probundle. The script heavily borrows from
...
#
#   ```
#   curl -sSL https://raw.githubusercontent.com/megabyte-labs/probundle/master/local/install.sh | sh
#   ```

RELEASES_URL="https://github.com/megabyte-labs/Probundle/releases"
